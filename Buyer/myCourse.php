 ...
 <div class="container mt-5 ml-2">
  <div class="row">
   ...
   if(isset($buyerLogEmail)){
    $sql = "SELECT co.order_id, c.course_id, c.course_name, c.course_duration, c.course_desc, c.course_img, c.course_instructor, c.course_original_price, c.course_price FROM courseorder AS co JOIN course AS c ON c.course_id = co.course_id WHERE co.buyer_email = '$buyerLogEmail'";
          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <small class="card-text">Instructor: <?php echo $row['course_instructor']; ?></small><br/>
